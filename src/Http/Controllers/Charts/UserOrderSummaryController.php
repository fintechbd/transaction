            ...
            if (Core::packageExists('Business', true)) {
                ...
                $orders = \Fintech\Business\Facades\Business::serviceType()
                    ...
                    ->map(function ($item) {
                        ...
                        $item->orders = [
                            ['currency' => 'CAD', 'total_amount' => 500, 'total_amount_formated' => \currency(500, 'CAD')],
                            ['currency' => 'AED', 'total_amount' => 1500, 'total_amount_formated' => \currency(1500, 'AED')],
                            ['currency' => 'BDT', 'total_amount' => 5000, 'total_amount_formated' => \currency(5000, 'BDT')],
                        ];
