 ...
 */
class ChartEntryRepository extends MongodbRepository implements InterfacesChartEntryRepository
{
    public function __construct()
    {
        $model = app(config('fintech.transaction.chart_entry_model', ChartEntry::class));
